...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { articulo: @producto.articulo, descripcion: @producto.descripcion, id_interna: @producto.id_interna, nombre: @producto.nombre, precio: @producto.precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { articulo: @producto.articulo, descripcion: @producto.descripcion, id_interna: @producto.id_interna, nombre: @producto.nombre, precio: @producto.precio } }
